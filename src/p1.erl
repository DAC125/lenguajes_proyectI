-module(p1).
-export([geneticosNReinas/1, generaPoblacion/2, cruce/7, generaLista/1, cortaPadre/3, encuentraPadre/2, encuentraElite/2, busquedaByValue/3, generacion/3, cicloMutacion/4, mutacion/3, ciclo_cruce/5, mutaCromosoma/3,mutaCromosoma2/4, fitnes/1] ). 
...
seleccion_respuesta(Colisiones,Poblacion,_N,_CantPoblacion,0,_PorMuta)-> ["NO"|Poblacion]++Colisiones;
...
seleccion_respuesta([],[],Colisiones,Poblacion,N,CantPoblacion,Cruce,PorMuta)-> ciclo_cruce(cruce(Poblacion,busquedaByValue(Poblacion,Colisiones,lists:min(Colisiones)),cortaPadre(encuentraPadre(Poblacion,rand:uniform(N)),N div 2,[]),encuentraPadre(Poblacion,rand:uniform(N)),[],CantPoblacion,N),N,CantPoblacion,Cruce-1,PorMuta);
...
cruce(_Poblacion,_Elite,_Padre,_Madre,NuevaPoblacion,0,N) -> cicloMutacion(NuevaPoblacion,round(length(NuevaPoblacion)*0.05),length(NuevaPoblacion),N) ;
...
cicloMutacion(Poblacion,CantMutaciones,CantPoblacion,N) -> cicloMutacion(mutacion(Poblacion,rand:uniform(CantPoblacion-1),N),CantMutaciones-1,CantPoblacion-1,N).
